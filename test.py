#!/usr/bin/env python3
#
# Test script for Rubeun's Bookmark Server.
#
# The server should be listening on port 8800, answer a GET request to /
...
def test_connect():
    ...
    try:
        ...
        return "Server didn't answer on localhost port 8800.  Is it running?"
...
def test_GET_path():
    ...
    uri = "http://localhost:8800/google"
