...
form = '''<!DOCTYPE html>
<title>Rubeun's Bookmark & URL Shortening Server</title>
<h1>Rubeun's Bookmark & URL Shortening Server</h1>
<form method="POST">
    <label>Long URI:
        <input name="longuri">
    </label>
...
class Shortener(http.server.BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        if name:
            ...
            known = "\n".join("<a href='{}' target='_blank'>{}</a>".format(memory[key], key)
